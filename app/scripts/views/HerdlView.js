        ...
        return `
            <div class="card">
				...
				<div class="card-action">
					<i class="material-icons right favorite heart">favorite_border</i>
					<a href="${this.url}">visit website</a>
					
					<i class="material-icons right down">keyboard_arrow_down</i>
<span class="vote-count right">${this.votes}</span>
    ...
    upVote: function () {
        ...
        let up_vote = 1;
        let down_vote = 0;
        $.post(`https://herdle-app.herokuapp.com/api/entries/${this.id}/votes`, {
            up_vote, down_vote
        });
